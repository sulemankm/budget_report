...
def test_periodEnd():
    assert report.Period("year").getPeriodEnd(dt(2021, 1, 1)) == dt(2021, 12, 31)
    assert report.Period("year").getPeriodEnd(dt(2021, 6, 3)) == dt(2021, 12, 31)
    assert report.Period("year").getPeriodEnd(dt(2021, 12, 31)) == dt(2021, 12, 31)
    assert report.Period("month").getPeriodEnd(dt(2021, 3, 1)) == dt(2021, 3, 31)
    assert report.Period("month").getPeriodEnd(dt(2021, 3, 15)) == dt(2021, 3, 31)
    assert report.Period("month").getPeriodEnd(dt(2021, 3, 31)) == dt(2021, 3, 31)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 1, 1)) == dt(2021, 6, 30)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 4, 3)) == dt(2021, 6, 30)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 6, 30)) == dt(2021, 6, 30)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 7, 1)) == dt(2021, 12, 31)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 9, 12)) == dt(2021, 12, 31)
    assert report.Period("biannual").getPeriodEnd(dt(2021, 12, 31)) == dt(2021, 12, 31)
    assert report.Period("week").getPeriodEnd(dt(2021, 3, 3)) == dt(2021, 3, 7)
    assert report.Period("week").getPeriodEnd(dt(2021, 3, 8)) == dt(2021, 3, 14)
    assert report.Period("week").getPeriodEnd(dt(2021, 3, 20)) == dt(2021, 3, 21)
    assert report.Period("week").getPeriodEnd(dt(2021, 3, 28)) == dt(2021, 3, 31)
    assert report.Period("day").getPeriodEnd(dt(2021, 3, 3)) == dt(2021, 3, 3)

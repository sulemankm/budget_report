...
def test_periodStart():
    ...
    assert period.Period("quarter").getPeriodStart(dt(2021, 1, 1)) == dt(2021, 1, 1).date()
    assert period.Period("quarter").getPeriodStart(dt(2021, 5, 15)) == dt(2021, 4, 1).date()
    assert period.Period("quarter").getPeriodStart(dt(2021, 8, 31)) == dt(2021, 7, 1).date()
    assert period.Period("quarter").getPeriodStart(dt(2021, 10, 1)) == dt(2021, 10, 1).date()
...
def test_periodEnd():
    ...
    assert period.Period("quarter").getPeriodEnd(dt(2021, 1, 1)) == dt(2021, 3, 31).date()
    assert period.Period("quarter").getPeriodEnd(dt(2021, 5, 15)) == dt(2021, 6, 30).date()
    assert period.Period("quarter").getPeriodEnd(dt(2021, 8, 31)) == dt(2021, 9, 30).date()
    assert period.Period("quarter").getPeriodEnd(dt(2021, 10, 1)) == dt(2021, 12, 31).date()
